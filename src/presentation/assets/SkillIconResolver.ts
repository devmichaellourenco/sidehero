...
const EXPLICIT_ICON_BY_ID: Record<string, SkillIconKey> = {
  ...
  evasion: 'evasion',
  fireball: 'fireball',
  frost_shard: 'arcane_bolt',
  blizzard: 'arcane_bolt',
...
const ID_PATTERN_RULES: Array<{ pattern: RegExp; icon: SkillIconKey }> = [
  ...
  { pattern: /bless|smite|judgment|banner|rally|glory|crown|decree/i, icon: 'blessing' },
  { pattern: /fire|pyro|flame|inferno|ember|burn/i, icon: 'fireball' },
  { pattern: /frost|blizz|ice|gelo|cold/i, icon: 'arcane_bolt' },
